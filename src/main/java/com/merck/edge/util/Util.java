...
public class Util {
	...
	public static ZonedDateTime toUserTimeZone(LocalDateTime time) {
		return ZonedDateTime.of(time, ZoneId.of(Constants.USER_TIMEZONE));
	}
	
//    public static ResponseEntity setResponse(HttpStatus httpStatus ,String status , String message) {
//		
